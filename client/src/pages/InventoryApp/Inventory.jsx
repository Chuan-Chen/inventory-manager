...
=======
function CreateItem({expanded, handleFocus, handleBlur, addData, user, access_token}){
...
=======
        <Page >
            ...
            <Content onClick={handleBlur}>
              <CreateItem expanded = {expanded}  handleBlur = {handleBlur} handleFocus = {handleFocus} addData = {addData} user = {user.user} access_token = {user.access_token}> 
